...
🚀 Project Overview
The Energy Grid Data Engineering Pipeline is an end-to-end data engineering project designed to ingest, process, validate, transform, and analyze energy-grid data using a modern cloud data platform.
...
WhatsApp Image 2026-09-04 at 5 50 16 PM
Fact Grain
...
dim_household Purpose: Stores descriptive attributes related to energy consumers/households.
